...
export const GALLERY_IMAGES: GalleryImage[] = [
  {
    id: 1,
    slug: 'baba-yaga-forest',
    title: 'Хозяйка лесной границы',
    creatureName: 'Баба-яга',
  ...
  },
  {
    id: 3,
    slug: 'rusalka-water',
    title: 'Под поверхностью воды',
    creatureName: 'Русалка',
    culture: 'Славянская традиция',
    region: 'Восточная Европа',
  ...
  {
    id: 6,
    slug: 'yuki-onna-winter',
    title: 'Белая тишина',
    creatureName: 'Юки-онна',
  ...
  {
    id: 8,
    slug: 'la-llorona-river',
    title: 'Плач у реки',
    creatureName: 'Ла Йорона',
...
image:
  ...
  {
    id: 11,
    slug: 'frozen-mountain',
    title: 'Граница холода',
    creatureName: 'Юки-онна',
    culture: 'Японский фольклор',
    region: 'Япония',
    category: 'Ёкаи',
